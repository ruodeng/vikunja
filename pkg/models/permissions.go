...
const (
	...
	// Can interact with projects and tasks, but cannot make structural changes.
	PermissionExecutor
...
func (r Permission) isValid() error {
	if r != PermissionAdmin && r != PermissionRead && r != PermissionWrite && r != PermissionExecutor {
